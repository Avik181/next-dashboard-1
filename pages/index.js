        ...
        <link rel="icon" href="/favicon.ico" />
            ...
            >
                ...
                >
                    ...
                    <Flex flexDir="column" alignItems="center" mb={10} mt={5}>
                        ...
                        <Text textAlign="center">Avik Baidya</Text>
                    </Flex>
                </Flex>
            </Flex>
            ...
            >
                <Heading
                    ...
                    letterSpacing="tight"
                >
                    Welcome back, <Flex display="inline-flex" fontWeight="bold">Avik</Flex>
                </Heading>
                <Text color="gray" fontSize="sm">My Balance</Text>
                <Text fontWeight="bold" fontSize="2xl">$6,904.20</Text>
                <MyChart />
                <Flex justifyContent="space-between" mt={8}>
                    <Flex align="flex-end">
                        <Heading as="h2" size="lg" letterSpacing="tight">Transactions</Heading>
                        <Text fontSize="small" color="gray" ml={4}>Dec 2021</Text>
                    </Flex>
                        ...
                        <Flex p="1em" color="#fff" flexDir="column" h="100%" justify="space-between">
                            <Flex justify="space-between" w="100%" align="flex-start">
                                <Flex flexDir="column">
                                    ...
                                    <Text fontWeight="bold" fontSize="xl">$6,904.20</Text>
                                </Flex>
                                <Flex align="center">
